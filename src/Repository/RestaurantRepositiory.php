...
class RestaurantRepository extends ServiceEntityRepository
{
    ...
    public function findNom($nomRestaurant)
    {
        $q = $this->createQueryBuilder('m')
            ->where('m.nomRestaurant LIKE :nomRestaurant')

            ->setParameter(':nomRestaurant', "%$nomRestaurant%");
    ...
    {/*$date_from = new \DateTime('now');
        ...
        return $this->createQueryBuilder('e')
            ...
            ->setParameter('nnomRestaurantom','%' .$search . '%')
            ->getQuery()
            ->getResult();
    }
