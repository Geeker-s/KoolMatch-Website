...
/**
     * @Route("reservation/ajouter/reservation" , name="reservation_ajouter" ,  methods={"GET", "POST"}, requirements={"idReservation":"\d+"})
     */
    public function ajouter(Request $request, SerializerInterface $serializer)
    {

        $Reservation = new Reservation();
        $nomResto = $request->query->get('nomResto');
        $nbplaceReservation = $request->query->get('nbplaceReservation');
