...
class RestaurantsController extends AbstractController
{
    ...
    public function add(\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $Restaurant->setImage( $file->getClientOriginalName());
    ...
    public function ajouter(Request $request, SerializerInterface $serializer)
    {
        ...
        $Restaurant = new Restaurant();
        $nomRestaurant = $request->request->get('nomRestaurant');
        $adresseRestaurant = $request->request->get('adresseRestaurant');
        $telephoneRestaurant = $request->request->get('telephoneRestaurant');
        $sitewebRestaurant = $request->request->get('sitewebRestaurant');
        $specialiteRestaurant = $request->request->get('specialiteRestaurant');
        $imageStructureResturant = $request->request->get('imageStructureResturant');
        $idGerant = $request->request->get('idGerant');
        $image = $request->request->get('image');
        $nbPlaceresto = $request->request->get('nbPlaceresto');
        ...
        $Restaurant->setTelephoneRestaurant(intval($telephoneRestaurant));
