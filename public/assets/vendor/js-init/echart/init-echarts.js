$(document).ready(function() {
    ...
    var chartOneDom = document.getElementById("basic_line_chart");
    ...
    var dom = document.getElementById("basic_area_chart");
    var myChart = echarts.init(dom);

    var app = {};
    option = null;
    option = {
        color: ['#328dff','#3dba6f', '#7a86ff' ],
    ...
    var dom = document.getElementById("rainfall_chart");
    ...
    var dom = document.getElementById("negative_bar_chart");
    var nbChart = echarts.init(dom);

    var app = {};
    option = null;
    option = {
        color: ['#fab63f','#fe413b', '#328dff' ],
        tooltip : {
            trigger: 'axis'
        },
        legend: {
    ...
    var dom = document.getElementById("basic_Pie_chart");
    ...
    var dom = document.getElementById("nested_Pie_chart");
    var npChart = echarts.init(dom);

    var app = {};
    option = null;
    option = {
        color: ['#31c3b2','#0071ff', '#ec0080','#b756ff', '#7a86ff', '#328dff', '#2f3c4b', '#18b9d4', '#fab63f', '#3dba6f' ],
        tooltip : {
            trigger: 'item',
            formatter: '{a} <br/>{b} : {c} ({d}%)'
        },
    ...
    var dom = document.getElementById("doughnut_chart");
    ...
    var dom = document.getElementById("basic_scatter_chart");
